...
//  createCanvas(windowWidth, windowHeight);
  ...
  //upload backgroun image of Bucknell
  bg = loadImage("bucknell.jpg")
...
function createBox() {
  ...
  textSize(29);           // size of the text (pixels)
  fill(400, 100, 0);      // fill() takes R,G,B values as the color
  // draw the text in the box (x,y,width,height) with the color in fill()
  textAlign(CENTER);
  text('Hello Bucknell!', BOX_WIDTH/2, BOX_HEIGHT/2);   
